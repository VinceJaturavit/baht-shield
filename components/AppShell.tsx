...
export function AppShell({ children }: AppShellProps) {
  ...
  return (
    <div className="min-h-screen bg-signal-bg">
      {/* Top nav */}
      <header className="w-full overflow-x-hidden border-b border-signal-border bg-signal-surface">
        <div className="mx-auto flex max-w-[1280px] items-center gap-3 px-4 lg:px-6">
          <div className="flex h-16 min-w-0 flex-1 items-center gap-3">
            ...
            <a
              ...
              className="shrink-0 text-signal-meta transition-colors hover:text-signal-slate"
            >
      ...
      <div className="border-b border-signal-borderSubtle bg-signal-surface">
