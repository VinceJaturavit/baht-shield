export function OpsCopilotRoadmapPanel() {
  return (
    <details className="min-w-0 border border-ourox-obsidianMid/60 bg-ourox-obsidian/10">
      <summary className="cursor-pointer px-3 py-2 text-[11px] font-medium text-ourox-ink/70 hover:text-ourox-ink focus:outline-none focus-visible:ring-2 focus-visible:ring-ourox-orange">
        Roadmap: live AI review
      </summary>
      <div className="border-t border-ourox-obsidianMid/60 px-3 py-2.5">
        <p className="max-w-3xl text-[10px] leading-relaxed text-ourox-ink/55">
        ...
        <p className="mt-2 max-w-3xl text-[10px] leading-relaxed text-ourox-ink/55">
