  ...
  return (
    <div className="rounded-lg border border-ourox-orange/20 bg-ourox-orange/[0.04] px-3 py-2.5">
      <p className="text-xs leading-relaxed text-ourox-ink/75">
        Fraud Analyst reserve is protected capacity. Fraud Analysts cannot be fully loaded with
        routine intake because RFR, LAR, escalations, QA, and final decisions require available
        senior capacity.
      </p>
      <p className="mt-1 text-[11px] text-ourox-ink/50">
        Fraud Analyst assignment capacity = total capacity minus protected reserve.
      </p>
